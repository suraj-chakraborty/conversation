...
var ChatList = /*#__PURE__*/function (_Component) {
  ...
  _proto.renderChats = function renderChats(chats) {
    ...
    return _.map(chats, function (chat, index) {
      ...
      }, chat.title, ' ', !_this.readLastMessage(_this.props.creds, chat) && /*#__PURE__*/React__default.createElement("div", {
        style: {
          "float": 'right',
          width: '12px',
          height: '12px',
  ...
  _proto.render = function render() {
    ...
    }), this.props.renderNewChatForm ? this.props.renderNewChatForm(creds) : /*#__PURE__*/React__default.createElement("div", {
...
var Avatar = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement("div", null, this.props.show_online !== false && /*#__PURE__*/React__default.createElement("div", {
      style: {
        width: '8px',
        height: '8px',
        borderRadius: '100%',
...
var TheirMessage = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, message.sender.username), /*#__PURE__*/React__default.createElement("div", {
      style: {
        display: 'auto',
        paddingLeft: '50px'
      }
...
var Message$1 = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(DatePartition, {
...
var ChatList$1 = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    })), this.props.renderNewMessageForm ? this.props.renderNewMessageForm(creds, chatId) : /*#__PURE__*/React__default.createElement(MessageForm, {
      chatId: chatId,
      creds: creds
    }));
  };
...
var Person = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, person.username !== admin.username ? person.username : person.username + " (Admin)"), this.state.selected && creds.userName === admin.username && person.username !== admin.username && /*#__PURE__*/React__default.createElement("div", {
      style: {
        "float": 'right',
        height: '0px',
        position: 'relative',
...
var ChatSettings = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(reactGridSystem.Row, null, /*#__PURE__*/React__default.createElement(reactGridSystem.Col, {
      xs: 3
...
var ChatSettingsContainer = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, this.props.renderChatSettings ? this.props.renderChatSettings(creds, chat) : /*#__PURE__*/React__default.createElement(ChatSettings, {
      creds: creds,
      chat: chat
    }), this.props.renderPeopleSettings ? this.props.renderPeopleSettings(creds, chat) : /*#__PURE__*/React__default.createElement(PeopleList, {
      creds: creds,
      chat: chat
    }), this.props.renderPhotosSettings ? this.props.renderPhotosSettings(chat) : /*#__PURE__*/React__default.createElement(Photos, {
      creds: creds,
      chat: chat
    }), creds && chat && creds.userName === chat.admin.username && /*#__PURE__*/React__default.createElement("div", null, this.props.renderOptionsSettings ? this.props.renderOptionsSettings(creds, chat) : /*#__PURE__*/React__default.createElement(Options, {
      creds: creds,
      chat: chat
    }))));
  };
...
var App = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, /*#__PURE__*/React__default.createElement(ChatList, {
    ...
    }, /*#__PURE__*/React__default.createElement(ChatList$1, {
      creds: this.state.creds,
      chats: this.state.chats,
    ...
    }, /*#__PURE__*/React__default.createElement(ChatSettingsContainer, {
      creds: this.state.creds,
